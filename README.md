...
const tones = getTones({ red: 238, green: 200, blue: 27 }, { size: 10, prefixed: true });
...
const tones = getTints({ red: 238, green: 200, blue: 27 }, { size: 10, prefixed: true });
...
const tones = getShades({ red: 238, green: 200, blue: 27 }, { size: 10, prefixed: true });
