...
exports.xyzToWideGamutRgb = exports.xyzToSmpteCRgb = exports.xyzToProPhotoRgb = exports.xyzToPalSecamRgb = exports.xyzToNtscRgb = exports.xyzToEtkaSpacePs5 = exports.xyzToDonRgb4 = exports.xyzToColorMatchRgb = exports.xyzToCieRgb = exports.xyzToBruceRgb = exports.xyzToBetaRgb = exports.xyzToBestRgb = exports.xyzToAppleRgb = exports.xyzToAdobeRgb = exports.xyzToSpaceRgb = exports.xyzToRgb = exports.Fv = exports.Fu = exports.xyzToLuv = exports.xyzToLab = void 0;
...
const xyzToSpaceRgb = ({ x, y, z }, ref) => {
    ...
    let green = x * G.x + y * G.y + z * G.z;
    let blue = x * B.x + y * B.y + z * B.z;
    red = Math.round((0, helpers_1.gammaRgb)(red, ref.GAMMA));
    green = Math.round((0, helpers_1.gammaRgb)(green, ref.GAMMA));
    blue = Math.round((0, helpers_1.gammaRgb)(blue, ref.GAMMA));
    return { red, green, blue };
};
exports.xyzToSpaceRgb = xyzToSpaceRgb;
/*******************************************************************
 *                        ADOBE 1998 RGB
 * *****************************************************************/
const xyzToAdobeRgb = (xyz) => {
    return (0, exports.xyzToSpaceRgb)(xyz, constants_1.SPACE_MATRICES.ADOBE_RGB_1998);
};
...
const xyzToAppleRgb = (xyz) => {
    return (0, exports.xyzToSpaceRgb)(xyz, constants_1.SPACE_MATRICES.APPLE_RGB);
};
...
const xyzToBestRgb = (xyz) => {
    return (0, exports.xyzToSpaceRgb)(xyz, constants_1.SPACE_MATRICES.BEST_RGB);
};
...
const xyzToBetaRgb = (xyz) => {
    return (0, exports.xyzToSpaceRgb)(xyz, constants_1.SPACE_MATRICES.BETA_RGB);
};
...
const xyzToBruceRgb = (xyz) => {
    return (0, exports.xyzToSpaceRgb)(xyz, constants_1.SPACE_MATRICES.BRUCE_RGB);
};
...
const xyzToCieRgb = (xyz) => {
    return (0, exports.xyzToSpaceRgb)(xyz, constants_1.SPACE_MATRICES.CIE_RGB);
};
...
const xyzToColorMatchRgb = (xyz) => {
    return (0, exports.xyzToSpaceRgb)(xyz, constants_1.SPACE_MATRICES.COLOR_MATCH_RGB);
};
...
const xyzToDonRgb4 = (xyz) => {
    return (0, exports.xyzToSpaceRgb)(xyz, constants_1.SPACE_MATRICES.DON_RGB_4);
};
...
const xyzToEtkaSpacePs5 = (xyz) => {
    return (0, exports.xyzToSpaceRgb)(xyz, constants_1.SPACE_MATRICES.ETKA_SPACE_PS5);
};
...
const xyzToNtscRgb = (xyz) => {
    return (0, exports.xyzToSpaceRgb)(xyz, constants_1.SPACE_MATRICES.NTSC_RGB);
};
...
const xyzToPalSecamRgb = (xyz) => {
    return (0, exports.xyzToSpaceRgb)(xyz, constants_1.SPACE_MATRICES.PAL_SECAM_RGB);
};
...
const xyzToProPhotoRgb = (xyz) => {
    return (0, exports.xyzToSpaceRgb)(xyz, constants_1.SPACE_MATRICES.PRO_PHOTO_RGB);
};
...
const xyzToSmpteCRgb = (xyz) => {
    return (0, exports.xyzToSpaceRgb)(xyz, constants_1.SPACE_MATRICES.SMPTE_C_RGB);
};
...
const xyzToWideGamutRgb = (xyz) => {
    return (0, exports.xyzToSpaceRgb)(xyz, constants_1.SPACE_MATRICES.WIDE_GAMUT_RGB);
};
