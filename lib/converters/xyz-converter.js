...
const xyzToRgb = ({ x, y, z }) => {
    ...
    red = Math.round((0, companding_1.sRbgCompanding)(red));
    green = Math.round((0, companding_1.sRbgCompanding)(green));
    blue = Math.round((0, companding_1.sRbgCompanding)(blue));
