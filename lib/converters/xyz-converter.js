...
const xyzToBestRgb = (xyz) => {
    const { x, y, z } = (0, chromatic_adaptation_1.D50toD65Adaptation)(xyz);
    return (0, exports.xyzToGammaRgb)({ x, y, z }, constants_1.SPACE_MATRICES.BEST_RGB);
};
...
const xyzToBetaRgb = (xyz) => {
    const { x, y, z } = (0, chromatic_adaptation_1.D50toD65Adaptation)(xyz);
    return (0, exports.xyzToGammaRgb)({ x, y, z }, constants_1.SPACE_MATRICES.BETA_RGB);
};
...
const xyzToCieRgb = (xyz) => {
    const { x, y, z } = (0, chromatic_adaptation_1.EtoD65Adaptation)(xyz);
    return (0, exports.xyzToGammaRgb)({ x, y, z }, constants_1.SPACE_MATRICES.CIE_RGB);
};
...
const xyzToColorMatchRgb = (xyz) => {
    const { x, y, z } = (0, chromatic_adaptation_1.D50toD65Adaptation)(xyz);
    return (0, exports.xyzToGammaRgb)({ x, y, z }, constants_1.SPACE_MATRICES.COLOR_MATCH_RGB);
};
...
const xyzToDonRgb4 = (xyz) => {
    const { x, y, z } = (0, chromatic_adaptation_1.D50toD65Adaptation)(xyz);
    return (0, exports.xyzToGammaRgb)({ x, y, z }, constants_1.SPACE_MATRICES.DON_RGB_4);
};
...
const xyzToEtkaSpacePs5 = (xyz) => {
    const { x, y, z } = (0, chromatic_adaptation_1.D50toD65Adaptation)(xyz);
    return (0, exports.xyzToGammaRgb)({ x, y, z }, constants_1.SPACE_MATRICES.ETKA_SPACE_PS5);
};
...
const xyzToNtscRgb = (xyz) => {
    const { x, y, z } = (0, chromatic_adaptation_1.CtoD65Adaptation)(xyz);
    return (0, exports.xyzToGammaRgb)({ x, y, z }, constants_1.SPACE_MATRICES.NTSC_RGB);
};
...
const xyzToProPhotoRgb = (xyz) => {
    const { x, y, z } = (0, chromatic_adaptation_1.D50toD65Adaptation)(xyz);
    return (0, exports.xyzToGammaRgb)({ x, y, z }, constants_1.SPACE_MATRICES.PRO_PHOTO_RGB);
};
...
const xyzToWideGamutRgb = (xyz) => {
    const { x, y, z } = (0, chromatic_adaptation_1.D50toD65Adaptation)(xyz);
    return (0, exports.xyzToGammaRgb)({ x, y, z }, constants_1.SPACE_MATRICES.WIDE_GAMUT_RGB);
};
...
const xyzToEciRgbV2 = (xyz) => {
    const { x, y, z } = (0, chromatic_adaptation_1.D50toD65Adaptation)(xyz);
    return (0, exports.xyzToLRgb)({ x, y, z });
};
