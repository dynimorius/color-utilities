...
exports.xyzToLsm = exports.xyzToXyY = exports.xyzToLRgb = exports.xyzToEciRgbV2 = exports.xyzToWideGamutRgb = exports.xyzToSmpteCRgb = exports.xyzToProPhotoRgb = exports.xyzToPalSecamRgb = exports.xyzToNtscRgb = exports.xyzToEtkaSpacePs5 = exports.xyzToDonRgb4 = exports.xyzToColorMatchRgb = exports.xyzToCieRgb = exports.xyzToBruceRgb = exports.xyzToBetaRgb = exports.xyzToBestRgb = exports.xyzToAppleRgb = exports.xyzToAdobeRgb = exports.xyzToGammaRgb = exports.xyzToSrgb = exports.xyzToRgb = exports.xyzToUvw = exports.xyzToLuv = exports.xyzToLab = void 0;
 ...
 */
const xyzToLsm = (xyz, matrix) => {
    if (!matrix)
        matrix = transform_matrixes_1.VON_KRIES_CONE_RESPONCE_DOMAINS.MA;
    return (0, matrix_1.matrixXyzMultiAsSpace)(matrix, xyz, ["long", "medium", "short"]);
};
exports.xyzToLsm = xyzToLsm;
