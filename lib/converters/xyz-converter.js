...
exports.Fv = Fv;
const xyzToRgb = ({ x, y, z }, space, compandingFun, gamma, whitInBounds) => {
    x = x > 1 ? x / 100 : x;
    y = y > 1 ? y / 100 : y;
    z = z > 1 ? z / 100 : z;
    //Get linear RGB
    ...
    return {
        red: whitInBounds ? (0, helpers_1.bound)(red) : red,
        green: whitInBounds ? (0, helpers_1.bound)(green) : green,
        blue: whitInBounds ? (0, helpers_1.bound)(blue) : blue,
...
const xyzToSrgb = (xyz) => {
    return (0, exports.xyzToRgb)(xyz, constants_1.SPACE_MATRICES.SRGB, companding_1.sRgbCompanding);
};
exports.xyzToSrgb = xyzToSrgb;
const xyzToLRgb = (xyz) => {
    return (0, exports.xyzToRgb)(xyz, constants_1.SPACE_MATRICES.ECI_RGB_V2, companding_1.LCompanding);
};
exports.xyzToLRgb = xyzToLRgb;
const xyzToGammaRgb = (xyz, ref) => {
    return (0, exports.xyzToRgb)(xyz, ref, companding_1.gammaCompanding, true);
};
...
const xyzToBestRgb = (xyz) => {
    return (0, exports.xyzToGammaRgb)((0, chromatic_adaptation_1.D65toD50Adaptation)(xyz), constants_1.SPACE_MATRICES.BEST_RGB);
};
...
const xyzToBetaRgb = (xyz) => {
    return (0, exports.xyzToGammaRgb)((0, chromatic_adaptation_1.D65toD50Adaptation)(xyz), constants_1.SPACE_MATRICES.BETA_RGB);
};
...
const xyzToCieRgb = (xyz) => {
    return (0, exports.xyzToGammaRgb)((0, chromatic_adaptation_1.D65toEAdaptation)(xyz), constants_1.SPACE_MATRICES.CIE_RGB);
};
...
const xyzToColorMatchRgb = (xyz) => {
    return (0, exports.xyzToGammaRgb)((0, chromatic_adaptation_1.D65toD50Adaptation)(xyz), constants_1.SPACE_MATRICES.COLOR_MATCH_RGB);
};
...
const xyzToDonRgb4 = (xyz) => {
    return (0, exports.xyzToGammaRgb)((0, chromatic_adaptation_1.D65toD50Adaptation)(xyz), constants_1.SPACE_MATRICES.DON_RGB_4);
};
...
const xyzToEtkaSpacePs5 = (xyz) => {
    return (0, exports.xyzToGammaRgb)((0, chromatic_adaptation_1.D65toD50Adaptation)(xyz), constants_1.SPACE_MATRICES.ETKA_SPACE_PS5);
};
...
const xyzToNtscRgb = (xyz) => {
    return (0, exports.xyzToGammaRgb)((0, chromatic_adaptation_1.D65toCAdaptation)(xyz), constants_1.SPACE_MATRICES.NTSC_RGB);
};
...
const xyzToProPhotoRgb = (xyz) => {
    return (0, exports.xyzToGammaRgb)((0, chromatic_adaptation_1.D65toD50Adaptation)(xyz), constants_1.SPACE_MATRICES.PRO_PHOTO_RGB);
};
...
const xyzToWideGamutRgb = (xyz) => {
    return (0, exports.xyzToGammaRgb)((0, chromatic_adaptation_1.D65toD50Adaptation)(xyz), constants_1.SPACE_MATRICES.WIDE_GAMUT_RGB);
};
