...
const lRgbToXyz = (rgb) => {
    return (0, exports.rgbToXyz)(rgb, constants_1.SPACE_MATRICES.ECI_RGB_V2, companding_1.inverseLCompanding);
};
exports.lRgbToXyz = lRgbToXyz;
const gammaRgbToXyz = (rgb, ref) => {
    return (0, exports.rgbToXyz)(rgb, ref, companding_1.inverseGammaCompanding, true);
};
...
const bestRgbToXyz = (rgb) => {
    return (0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.BEST_RGB);
};
...
const betaRgbToXyz = (rgb) => {
    return (0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.BETA_RGB);
};
...
const cieRgbToXyz = (rgb) => {
    return (0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.CIE_RGB);
};
...
const colorMatchRgbToXyz = (rgb) => {
    return (0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.COLOR_MATCH_RGB);
};
...
const donRgb4ToXyz = (rgb) => {
    return (0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.DON_RGB_4);
};
...
const etkaSpacePs5ToXyz = (rgb) => {
    return (0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.ETKA_SPACE_PS5);
};
...
const ntscRgbToXyz = (rgb) => {
    return (0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.NTSC_RGB);
};
...
const proPhotoRgbToXyz = (rgb) => {
    return (0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.PRO_PHOTO_RGB);
};
...
const wideGamutRgbToXyz = (rgb) => {
    return (0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.WIDE_GAMUT_RGB);
};
...
const eciRgbV2ToXyz = (rgb) => {
    return (0, exports.lRgbToXyz)(rgb);
};
 ...
 * *****************************************************************/
const sRgbToXyz = (rgb) => {
    return (0, exports.rgbToXyz)(rgb, constants_1.SPACE_MATRICES.SRGB, companding_1.inverseSrbgCompanding);
};
