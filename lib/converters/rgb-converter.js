...
exports.rgbToRyb = exports.rgbToHwb = exports.rgbToHcg = exports.rgbToHsv = exports.rgbToHsl = exports.rgbaToHex = exports.rgbToHex = exports.rgbToLch_uv = exports.rgbToLch_ab = exports.rgbToLuv = exports.rgbToLab = exports.rgbToAnsi256 = exports.rgbToAnsi16 = exports.sRgbToXyz = exports.eciRgbV2ToXyz = exports.wideGamutRgbToXyz = exports.smpteCRgbToXyz = exports.proPhotoRgbToXyz = exports.palSecamRgbToXyz = exports.ntscRgbToXyz = exports.etkaSpacePs5ToXyz = exports.donRgb4ToXyz = exports.colorMatchRgbToXyz = exports.cieRgbToXyz = exports.bruceRgbToXyz = exports.betaRgbToXyz = exports.bestRgbToXyz = exports.appleRgbToXyz = exports.adobeRgbToXyz = exports.rgbToAdobeRgb = exports.gammaRgbToXyz = exports.lRgbToXyz = exports.comparativeDistance = exports.rgbToCmyk = exports.sRgbToLuminance = exports.rgbTo1_0rgb = exports.rgbToHue = exports.getRange = exports.rgbInvert = exports.normalizeRgba = exports.normalizeRgb = void 0;
...
const lRgbToXyz = (rgb) => {
    return rgbToXyz(rgb, constants_1.SPACE_MATRICES.ECI_RGB_V2, companding_1.inverseLCompanding);
};
...
const adobeRgbToXyz = (rgb) => {
    return (0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.ADOBE_RGB_1998);
};
...
const appleRgbToXyz = (rgb) => {
    return (0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.APPLE_RGB);
};
...
const bestRgbToXyz = (rgb) => {
    return (0, chromatic_adaptation_1.D50toD65Adaptation)((0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.BEST_RGB));
};
...
const betaRgbToXyz = (rgb) => {
    return (0, chromatic_adaptation_1.D50toD65Adaptation)((0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.BETA_RGB));
};
...
const bruceRgbToXyz = (rgb) => {
    return (0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.BRUCE_RGB);
};
...
const cieRgbToXyz = (rgb) => {
    return (0, chromatic_adaptation_1.EtoD65Adaptation)((0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.CIE_RGB));
};
...
const colorMatchRgbToXyz = (rgb) => {
    return (0, chromatic_adaptation_1.D50toD65Adaptation)((0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.COLOR_MATCH_RGB));
};
...
const donRgb4ToXyz = (rgb) => {
    return (0, chromatic_adaptation_1.D50toD65Adaptation)((0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.DON_RGB_4));
};
...
const etkaSpacePs5ToXyz = (rgb) => {
    return (0, chromatic_adaptation_1.D50toD65Adaptation)((0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.ETKA_SPACE_PS5));
};
...
const ntscRgbToXyz = (rgb) => {
    return (0, chromatic_adaptation_1.CtoD65Adaptation)((0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.NTSC_RGB));
};
...
const palSecamRgbToXyz = (rgb) => {
    return (0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.PAL_SECAM_RGB);
};
...
const proPhotoRgbToXyz = (rgb) => {
    return (0, chromatic_adaptation_1.D50toD65Adaptation)((0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.PRO_PHOTO_RGB));
};
...
const smpteCRgbToXyz = (rgb) => {
    return (0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.SMPTE_C_RGB);
};
...
const wideGamutRgbToXyz = (rgb) => {
    return (0, chromatic_adaptation_1.D50toD65Adaptation)((0, exports.gammaRgbToXyz)(rgb, constants_1.SPACE_MATRICES.WIDE_GAMUT_RGB));
};
 ...
 * *****************************************************************/
const sRgbToXyz = (rgb) => {
    return rgbToXyz(rgb, constants_1.SPACE_MATRICES.SRGB, companding_1.inverseSrbgCompanding);
};
 ...
 *                             LAB
 * *****************************************************************/
const rgbToLab = (rgb, xyz = (0, exports.sRgbToXyz)(rgb)) => {
 ...
 *                             LUV
 * *****************************************************************/
const rgbToLuv = (rgb, xyz = (0, exports.sRgbToXyz)(rgb)) => {
 ...
 *                             LCH
 * *****************************************************************/
const rgbToLch_ab = (rgb, xyz = (0, exports.sRgbToXyz)(rgb)) => {
    return (0, lab_converter_1.labToLch_ab)((0, xyz_converter_1.xyzToLab)(xyz));
};
exports.rgbToLch_ab = rgbToLch_ab;
const rgbToLch_uv = (rgb, xyz = (0, exports.sRgbToXyz)(rgb)) => {
 ...
 *                             HCG
 * *****************************************************************/
const rgbToHcg = (rgb, hue) => {
    const { red, green, blue } = (0, exports.normalizeRgb)(rgb);
    const { min, max, delta } = (0, exports.getRange)(red, green, blue);
    const grayscale = delta < 1 ? min / (1 - delta) : 0;
    hue = hue ? hue : (0, exports.rgbToHue)(red, green, blue, max, delta);
