...
const rgbToXyz = ({ red, green, blue }) => {
    const Rlin = (0, companding_1.inverseSrbgCompanding)(red);
    const Glin = (0, companding_1.inverseSrbgCompanding)(green);
    const Blin = (0, companding_1.inverseSrbgCompanding)(blue);
...
const gammaRgbToXyz = ({ red, green, blue }, ref) => {
    const Rlin = (0, companding_1.inverseGammaCompanding)(red, ref.GAMMA);
    const Glin = (0, companding_1.inverseGammaCompanding)(green, ref.GAMMA);
    const Blin = (0, companding_1.inverseGammaCompanding)(blue, ref.GAMMA);
