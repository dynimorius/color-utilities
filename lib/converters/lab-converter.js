...
const labToXyz = ({ luminance, a, b }) => {
    ...
    const z = f(fY - b / 200) * constants_1.REFERENCE_WHITES.D65.Z * 100 + 0;
    const x = f(a / 500 + fY) * constants_1.REFERENCE_WHITES.D65.X * 100 + 0;
    const y = (luminance > constants_1.CIE_κ * constants_1.CIE_ϵ
        ? Math.pow((luminance + 16) / 116, 3)
        : luminance / constants_1.CIE_κ) *
        constants_1.REFERENCE_WHITES.D65.Y *
        100 + 0;
    return { x, y, z };
};
