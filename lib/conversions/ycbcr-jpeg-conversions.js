...
exports.yCbCrBT2020ToSrgb =
  exports.yCbCrBT709ToSrgb =
  exports.yCbCrBT601ToYPbPr =
  exports.yCbCrBT601ToXvYcc =
  exports.yCbCrBT601ToSrgb =
    void 0;
/**
 * @license
...
const yCbCrBT601ToSrgb = ({ Y, Cb, Cr }) => {
  const { red, green, blue } = (0, matrix_1.matrixByVectorObjMultiAsSpace)(
    cb_cr_conversions_matrices_1.CB_CR_CONVERSION_MATRICES.BT_601_YCBCR_TO_RGB,
...
const yCbCrBT709ToSrgb = ({ Y, Cb, Cr }) => {
  const { red, green, blue } = (0, matrix_1.matrixByVectorObjMultiAsSpace)(
    cb_cr_conversions_matrices_1.CB_CR_CONVERSION_MATRICES.BT_709_YCBCR_TO_RGB,
    { Y, Cb, Cr },
    ["red", "green", "blue"]
  );
  return {
