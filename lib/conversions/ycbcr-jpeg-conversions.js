...
const yCbCrBT601ToSrgb = ({ Y, Cb, Cr }) => {
    const { red, green, blue } = (0, matrix_1.matrixByVectorObjMultiAsSpace)(cb_cr_conversions_matrices_1.CB_CR_CONVERSION_MATRICES.YCBCR_TO_RGB, { Y: Y - 16, Cb: Cb - 128, Cr: Cr - 128 }, ["red", "green", "blue"]);
    // const blue = Y + Cb * 1.772;
    // const red = Y + Cr * 1.402;
    // const green = (Y - (0.114 * blue + 0.299 * red)) / 0.587;
    return {
        red: Math.round(red),
