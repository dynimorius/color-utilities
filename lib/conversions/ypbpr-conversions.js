...
const yPbPrToSrgb = ({ Y, Pb, Pr }) => {
    const { red, green, blue } = (0, matrix_1.matrixByVectorObjMultiAsSpace)(cb_cr_conversions_coefficients_1.CB_CR_CONVERSION_MATRICES.YPBPR_TO_RGB, { Y, Pb, Pr }, ["red", "green", "blue"]);
