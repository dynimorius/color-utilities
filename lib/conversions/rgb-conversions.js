...
const sRgbToYcCbcCrc = ({ red, green, blue }) => {
    console.log((0, yccbccrc_conversions_1.ycCbcCrcToSrgb)((0, matrix_1.matrixByVectorObjMultiAsSpace)(cb_cr_conversions_matrices_1.CB_CR_CONVERSION_MATRICES.YCCRCCBC_TO_RGB, { red, green, blue }, ["Yc", "Cbc", "Crc"])));
    return (0, matrix_1.matrixByVectorObjMultiAsSpace)(cb_cr_conversions_matrices_1.CB_CR_CONVERSION_MATRICES.YCCRCCBC_TO_RGB, { red, green, blue }, ["Yc", "Cbc", "Crc"]);
};
...
const sRgbToYiq = ({ red, green, blue }) => {
    const { Y, I, Q } = (0, matrix_1.matrixByVectorObjMultiAsSpace)(cb_cr_conversions_matrices_1.CB_CR_CONVERSION_MATRICES.RGB_TO_YIQ, { red, green, blue }, ["Y", "I", "Q"]);
