...
const sRgbToYcCbcCrc = (rgb) => {
    ...
    (0, yccbccrc_conversions_1.ycCbcCrcToSrgb)({
        Yc,
 ...
 */
const sRgbToYuv = (rgb, normalize) => {
    const { red, green, blue } = normalize ? (0, exports.normalizeRgb)(rgb) : rgb;
    const y = red * 0.299 + green * 0.587 + blue * 0.114;
    const u = 0.492 * (blue - y);
    const v = 0.877 * (red - y);
    // return { y, u, v };
    const yuv = (0, cb_cr_coef_conversions_1.sRgbByMatrix)(rgb, cb_cr_conversions_coefficients_1.CB_CR_CONVERSION_MATRICES.RGB_TO_YUV, ["y", "u", "v"]);
    return yuv;
};
