...
const sRgbToYcCbcCrc = ({ red, green, blue }) => {
    ...
    console.log((0, yccbccrc_conversions_1.ycCbcCrcToSrgb)({ Yc, Cbc, Crc }));
    return { Yc, Cbc, Crc };
};
