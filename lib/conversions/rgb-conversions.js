 ...
 */
const sRgbToYPbPr = ({ red, green, blue }, ituRBt = cb_cr_conversions_coefficients_1.CB_CR_CONVERSIONS_COEFFICIENTS.ITU_R_BT_709) => {
...
const sRgbToYcCbcCrc = (rgb) => {
    return (0, exports.sRgbToYPbPr)(rgb, cb_cr_conversions_coefficients_1.CB_CR_CONVERSIONS_COEFFICIENTS.ITU_R_BT_2020);
};
