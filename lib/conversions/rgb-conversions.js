...
const sRgbToYCbCrBT601 = ({ red, green, blue }) => {
    ...
    const { Y, Cb, Cr } = (0, matrix_1.matrixByVectorObjMultiAsSpace)(cb_cr_conversions_matrices_1.CB_CR_CONVERSION_MATRICES.RGB_TO_YCBCR, { red, green, blue }, ["Y", "Cb", "Cr"]);
    console.log((0, ycbcr_jpeg_conversions_1.yCbCrBT601ToSrgb)({
        Y: 16 + Y,
        Cb: 128 + Cb,
        Cr: 128 + Cr,
    }));
    ...
    // const Cb = blue - Y / 1.772;
    // const Cr = red - Y / 1.402;
    // console.log(yCbCrBT601ToSrgb({Y, Cb, Cr}))
    // return {Y, Cb, Cr}
};
