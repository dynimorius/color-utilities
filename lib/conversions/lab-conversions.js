...
exports.hunterLabToXyz = exports.labToLch_ab = exports.labToXyz = void 0;
...
const labToXyz = ({ luminance, a, b }) => {
  ...
  const z =
    f(fY - b / 200) * reference_illuminants_1.REFERENCE_ILLUMINANT.D65.Z * 100 +
    0;
  const x =
    f(a / 500 + fY) * reference_illuminants_1.REFERENCE_ILLUMINANT.D65.X * 100 +
    0;
  const y =
    (luminance > conditionals_1.CIE_κ * conditionals_1.CIE_ϵ
...
const f = (num) => {
  return Math.pow(num, 3) > conditionals_1.CIE_ϵ
    ? Math.pow(num, 3)
    : (116 * num - 16) / conditionals_1.CIE_κ;
};
/**
