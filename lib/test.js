...
const lms_converter_1 = require("./converters/lms-converter");
...
const lsm = (0, public_api_1.xyzToLsm)((_3 = checkColor.data) === null || _3 === void 0 ? void 0 : _3.xyz);
console.log(lsm);
console.log((0, lms_converter_1.lmsToXyz)(lsm));
