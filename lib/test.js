...
console.log((0, harmony_1.triadicHarmonyHsl)(checkColor.data.hsl, true));
console.log((0, harmony_1.complementaryHarmonyHsl)(checkColor.data.hsl, true));
console.log((0, harmony_1.squareHarmonyHsl)(checkColor.data.hsl, true));
console.log((0, harmony_1.splitComplementaryHarmonyHsl)(checkColor.data.hsl, true));
console.log((0, harmony_1.splitComplementaryCWHarmonyHsl)(checkColor.data.hsl, true));
console.log((0, harmony_1.splitComplementaryCCWHarmonyHsl)(checkColor.data.hsl, true));
