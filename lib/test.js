...
const mixer_1 = require("./utilities/mixer");
let pass = 0;
let fail = 0;
...
console.log((0, mixer_1.getShades)(testColor, { prefexed: true }));
console.log((0, harmony_1.fourToneCWHarmonyHsl)(checkColor.data.hsl, true));
