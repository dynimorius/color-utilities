...
const companding = ({ red, green, blue }, compandingFun, options) => {
    ...
    return {
        red: (options === null || options === void 0 ? void 0 : options.whitInBounds) ? (0, formats_and_checks_1.bound)(red) : red,
        green: (options === null || options === void 0 ? void 0 : options.whitInBounds) ? (0, formats_and_checks_1.bound)(green) : green,
        blue: (options === null || options === void 0 ? void 0 : options.whitInBounds) ? (0, formats_and_checks_1.bound)(blue) : blue,
