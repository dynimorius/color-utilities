...
exports.linearCompanding = exports.inverseLCompanding = exports.LCompanding = exports.inverseGammaCompanding = exports.gammaCompanding = exports.inverseSrbgCompanding = exports.sRbgCompanding = void 0;
const constants_1 = require("../constants");
const matrix_1 = require("./matrix");
const sRbgCompanding = (value) => {
    return ((value <= constants_1.GAMMA_NORMALIZED_BELOW
        ? 12.92 * value
        : 1.055 * Math.pow(value, 0.416666) - 0.055) * 255);
};
exports.sRbgCompanding = sRbgCompanding;
