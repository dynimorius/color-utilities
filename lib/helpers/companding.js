...
exports.inverseCompanding =
  exports.inverseLCompanding =
  exports.inverseGammaCompanding =
  exports.inverseSrbgCompanding =
  exports.companding =
  exports.LCompanding =
  exports.gammaCompanding =
  exports.sRgbCompanding =
    void 0;
...
const sRgbCompanding = (value) => {
  return (
    (value <= conditionals_1.SRGB_NORMALIZED_BELOW
      ? 12.92 * value
...
const LCompanding = (value) => {
  return (
    (value <= conditionals_1.CIE_ϵ
      ? (value * conditionals_1.CIE_κ) / 100
      : 1.16 * Math.cbrt(value) - 0.16) * 255
  );
};
  ...
  if (options === null || options === void 0 ? void 0 : options.rounded) {
    red = Math.round(
      compandingFun(
        ...[
          red,
          options === null || options === void 0 ? void 0 : options.gamma,
        ]
      )
    );
    green = Math.round(
    ...
    red = compandingFun(
      ...[red, options === null || options === void 0 ? void 0 : options.gamma]
    );
    green = compandingFun(
      ...[
        green,
    ...
    blue = compandingFun(
      ...[blue, options === null || options === void 0 ? void 0 : options.gamma]
    );
  }
  return {
    red: (
      ...
      ? (0, formats_and_checks_1.bound)(red)
      : red,
    green: (
      options === null || options === void 0 ? void 0 : options.whitInBounds
    )
      ? (0, formats_and_checks_1.bound)(green)
      : green,
    blue: (
      options === null || options === void 0 ? void 0 : options.whitInBounds
    )
      ? (0, formats_and_checks_1.bound)(blue)
      : blue,
    inGamut:
      (0, formats_and_checks_1.gamutCheck)(red) &&
      (0, formats_and_checks_1.gamutCheck)(green) &&
      (0, formats_and_checks_1.gamutCheck)(blue),
  };
};
