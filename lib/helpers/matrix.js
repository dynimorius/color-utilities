...
exports.matrixXyzMultiAsSpace = exports.matrixSpaceMultiAsXyz = exports.matrixSpaceMulti = exports.matrixVectorMultiAsXyz = exports.matrixByVectorObjMulti = exports.matrixVectorMulti = exports.matrix3x3Multi = void 0;
/**
 ...
 */
const matrixSpaceMulti = (matrix, vector) => {
    const entries = Object.entries(vector);
    return {
        [entries[0][0]]: matrix[0][0] * entries[0][1] +
            matrix[0][1] * entries[1][1] +
...
exports.matrixSpaceMulti = matrixSpaceMulti;
/**
 * Multiplication of a 3 x 3 Matrix by a Color Space object
 * @param {Matrix3x3} matrix 3 x 3 matrix
 * @param {{ [key: string]: number }} vector a vector object
