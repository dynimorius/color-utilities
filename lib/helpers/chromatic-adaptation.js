 ...
 */
const linearTransformationM = (sourceWhite, destinationWhite) => {
    const Ma = transform_matrixes_1.BRADFORD_CONE_RESPONCE_DOMAINS.MA;
    const Ma_1 = transform_matrixes_1.BRADFORD_CONE_RESPONCE_DOMAINS.MA_1;
...
const chromaticAdaptation = (xyz, sRefWhite, dRefWhite) => {
    const M = linearTransformationM([sRefWhite.X, sRefWhite.Y, sRefWhite.Z], [dRefWhite.X, dRefWhite.Y, dRefWhite.Z]);
...
const D55toAAdaptation = (xyz) => {
    return (0, exports.chromaticAdaptationPreCal)(xyz, adaptive_matrices_1.ADAPTIVE_MATRICES.D55_A);
};
...
const D55toBAdaptation = (xyz) => {
    return (0, exports.chromaticAdaptationPreCal)(xyz, adaptive_matrices_1.ADAPTIVE_MATRICES.D55_B);
};
...
const D55toCAdaptation = (xyz) => {
    return (0, exports.chromaticAdaptationPreCal)(xyz, adaptive_matrices_1.ADAPTIVE_MATRICES.D55_C);
};
...
const D55toD50Adaptation = (xyz) => {
    return (0, exports.chromaticAdaptationPreCal)(xyz, adaptive_matrices_1.ADAPTIVE_MATRICES.D55_D50);
};
...
const D55toD65Adaptation = (xyz) => {
    return (0, exports.chromaticAdaptationPreCal)(xyz, adaptive_matrices_1.ADAPTIVE_MATRICES.D55_D65);
};
...
const D55toD75Adaptation = (xyz) => {
    return (0, exports.chromaticAdaptationPreCal)(xyz, adaptive_matrices_1.ADAPTIVE_MATRICES.D55_D75);
};
...
const D55toEAdaptation = (xyz) => {
    return (0, exports.chromaticAdaptationPreCal)(xyz, adaptive_matrices_1.ADAPTIVE_MATRICES.D55_E);
};
...
const D55toF2Adaptation = (xyz) => {
    return (0, exports.chromaticAdaptationPreCal)(xyz, adaptive_matrices_1.ADAPTIVE_MATRICES.D55_F2);
};
...
const D55toF7Adaptation = (xyz) => {
    return (0, exports.chromaticAdaptationPreCal)(xyz, adaptive_matrices_1.ADAPTIVE_MATRICES.D55_F7);
};
...
const D55toF11Adaptation = (xyz) => {
    return (0, exports.chromaticAdaptationPreCal)(xyz, adaptive_matrices_1.ADAPTIVE_MATRICES.D55_F11);
};
