...
exports.rgbConverters = {
    ...
    ansi16: { fun: rgb_converter_1.rgbToAnsi16, from: "rgb" },
    ansi256: { fun: rgb_converter_1.rgbToAnsi256, from: "rgb" },
    ...
    cmyk: { fun: rgb_converter_1.rgbToCmyk, from: "rgb" },
    ...
    hcg: { fun: rgb_converter_1.rgbToHcg, from: "rgb" },
    hex: { fun: rgb_converter_1.rgbToHex, from: "rgb" },
    hsl: { fun: rgb_converter_1.rgbToHsl, from: "rgb" },
    hsv: { fun: rgb_converter_1.rgbToHsv, from: "rgb" },
    hwb: { fun: rgb_converter_1.rgbToHwb, from: "rgb" },
    lab: { fun: xyz_converter_1.xyzToLab, from: "xyz" },
    lch_ab: { fun: rgb_converter_1.rgbToLch_ab, from: "rgb" },
    lch_uv: { fun: rgb_converter_1.rgbToLch_uv, from: "rgb" },
    ...
    ryb: { fun: rgb_converter_1.rgbToRyb, from: "rgb" },
    smpte_c_rgb: { fun: xyz_converter_1.xyzToSmpteCRgb, from: "xyz" },
    xyz: { fun: rgb_converter_1.rgbToXyz, from: "rgb" },
