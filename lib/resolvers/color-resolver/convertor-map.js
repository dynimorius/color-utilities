...
const yuv_conversions_1 = require("../../conversions/yuv.conversions");
...
exports.colorConverters = {
    ...
    ycbcr: { fun: rgb_conversions_1.sRgbToYCbCr, from: "rgb" },
    ...
    yuv: { fun: rgb_conversions_1.sRgbToYuv, from: "rgb" },
};
/**
...
exports.toRgbConverters = {
    ...
    ycbcr: ycbcr_jpeg_conversions_1.yCbCrToSrgb,
    ...
    yuv: yuv_conversions_1.yuvToRgb
};
/**
