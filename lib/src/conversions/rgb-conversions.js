...
exports.sRgbToHsl =
  ...
  exports.sRgbToCmyk =
  exports.sRgbToCmy =
  exports.sRgbToAnsi256 =
  exports.sRgbToAnsi16 =
  exports.sRgbToXyz =
  exports.lRgbToXyz =
  exports.eciRgbV2ToXyz =
  exports.sRgbToEciRgbV2 =
  exports.wideGamutRgbToXyz =
  exports.sRgbToWideGamutRgb =
  exports.smpteCRgbToXyz =
  exports.sRgbToSmpteCRgb =
  exports.proPhotoRgbToXyz =
  exports.sRgbToProPhotoRgb =
  exports.palSecamRgbToXyz =
  exports.sRgbToPalSecamRgb =
  exports.ntscRgbToXyz =
  exports.sRgbToNtscRgb =
  exports.etkaSpacePs5ToXyz =
  exports.sRgbToEtkaSpacePs5 =
  exports.donRgb4ToXyz =
  exports.sRgbToColorDonRgb4 =
  exports.colorMatchRgbToXyz =
  exports.sRgbToColorMatchRgb =
  exports.cieRgbToXyz =
  exports.sRgbToCieRgb =
  exports.bruceRgbToXyz =
  exports.sRgbToBruceRgb =
  exports.betaRgbToXyz =
  exports.sRgbToBetaRgb =
  exports.bestRgbToXyz =
  exports.sRgbToBestRgb =
  exports.appleRgbToXyz =
  exports.sRgbToAppleRgb =
  exports.adobeRgbToXyz =
  exports.sRgbToAdobeRgb =
  exports.comparativeDistance =
  exports.sRgbToLuminance =
  exports.rgbTo1_0rgb =
  exports.rgbToHue =
  exports.getRange =
  exports.rgbInvert =
  exports.deNormalizeRGB =
  exports.normalizeRgba =
  exports.normalizeRgb =
    void 0;
exports.sRgbToXvYcc =
  exports.sRgbToYiq =
  exports.sRgbToYCgCo =
  exports.sRgbToYcCbcCrc =
  exports.sRgbToYPbPr =
  exports.sRgbToYDbDr =
  exports.sRgbToYCbCrBT2020 =
  exports.sRgbToYCbCrBT709 =
  exports.sRgbToYCbCrBT601 =
  exports.gammaRgbToXyz =
  exports.sRgbToUvw =
  exports.sRgbToTsl =
  exports.sRgbToRyb =
  exports.sRgbToLuv =
  exports.sRgbToLch_uv =
...
const adobeRgbToXyz = (rgb) => {
  return (0, exports.gammaRgbToXyz)(
    rgb,
...
const bestRgbToXyz = (rgb) => {
  return (0, chromatic_adaptation_1.D50toD65Adaptation)(
    (0, exports.gammaRgbToXyz)(rgb, space_datasets_1.SPACE_DATASETS.BEST_RGB)
  );
};
...
const betaRgbToXyz = (rgb) => {
  return (0, chromatic_adaptation_1.D50toD65Adaptation)(
    (0, exports.gammaRgbToXyz)(rgb, space_datasets_1.SPACE_DATASETS.BETA_RGB)
  );
};
...
const cieRgbToXyz = (rgb) => {
  return (0, chromatic_adaptation_1.EtoD65Adaptation)(
    (0, exports.gammaRgbToXyz)(rgb, space_datasets_1.SPACE_DATASETS.CIE_RGB)
  );
};
 ...
 */
const sRgbToColorDonRgb4 = (rgb, xyz = (0, exports.sRgbToXyz)(rgb)) => {
  return (0, xyz_conversions_1.xyzToDonRgb4)(xyz);
};
exports.sRgbToColorDonRgb4 = sRgbToColorDonRgb4;
/**
...
const donRgb4ToXyz = (rgb) => {
  return (0, chromatic_adaptation_1.D50toD65Adaptation)(
    (0, exports.gammaRgbToXyz)(rgb, space_datasets_1.SPACE_DATASETS.DON_RGB_4)
  );
};
...
const ntscRgbToXyz = (rgb) => {
  return (0, chromatic_adaptation_1.CtoD65Adaptation)(
    (0, exports.gammaRgbToXyz)(rgb, space_datasets_1.SPACE_DATASETS.NTSC_RGB)
  );
};
...
const lRgbToXyz = (rgb) => {
  return rgbToXyz(
    ...
    companding_1.inverseLCompanding
  );
};
...
const sRgbToXyz = (rgb) => {
  return rgbToXyz(
    ...
    companding_1.inverseSrbgCompanding
  );
};
...
const sRgbToAnsi16 = (rgb, saturation = null) => {
  ...
  let value =
    saturation !== null && saturation !== void 0
      ? saturation
      : (0, exports.sRgbToHsv)(rgb).value;
...
const sRgbToHsl = (rgb, pHue) => {
  ...
  if (!delta) return { hue, saturation, lightness };
    ...
    saturation = (0, formats_and_checks_1.formatValue)(
      lightness > 0.5 ? delta / (2 - max - min) : delta / (max + min)
    );
  if (!pHue) hue = (0, exports.rgbToHue)(red, green, blue, max, delta);
  else hue = pHue;
...
const sRgbToHsv = (rgb, pHue) => {
  ...
  let saturation = (0, formats_and_checks_1.formatValue)(
    max === 0 ? 0 : delta / max
  );
...
const sRgbToLch_ab = (rgb, xyz = (0, exports.sRgbToXyz)(rgb)) => {
  return (0, lab_conversions_1.labToLch_ab)(
    (0, xyz_conversions_1.xyzToLab)(xyz)
  );
};
...
const sRgbToLch_uv = (rgb, xyz = (0, exports.sRgbToXyz)(rgb)) => {
  return (0, luv_conversions_1.luvToLch_uv)(
    (0, xyz_conversions_1.xyzToLuv)(xyz)
  );
};
...
const rgbToXyz = (rgb, space, inverseCompandingFun, gamma) => {
  const { Rlin, Glin, Blin } = (0, companding_1.inverseCompanding)(
    rgb,
    space,
...
const sRgbToYCbCrBT601 = ({ red, green, blue }) => {
  const { Y, Cb, Cr } = (0, matrix_1.matrixByVectorObjMultiAsSpace)(
    cb_cr_conversions_matrices_1.CB_CR_CONVERSION_MATRICES.RGB_TO_YCBCR_BT_601,
    { red, green, blue },
    ["Y", "Cb", "Cr"]
  );
  return {
...
const sRgbToYCbCrBT709 = ({ red, green, blue }) => {
  return (0, matrix_1.matrixByVectorObjMultiAsSpace)(
    cb_cr_conversions_matrices_1.CB_CR_CONVERSION_MATRICES.RGB_TO_BT_709_YCBCR,
    { red, green, blue },
    ["Y", "Cb", "Cr"]
  );
};
...
const sRgbToYDbDr = ({ red, green, blue }) => {
  return (0, matrix_1.matrixByVectorObjMultiAsSpace)(
    cb_cr_conversions_matrices_1.CB_CR_CONVERSION_MATRICES.RGB_TO_YDBDR,
    { red, green, blue },
    ["Y", "Db", "Dr"]
  );
};
...
const sRgbToYPbPr = ({ red, green, blue }) => {
  return (0, matrix_1.matrixByVectorObjMultiAsSpace)(
    cb_cr_conversions_matrices_1.CB_CR_CONVERSION_MATRICES.RGB_TO_YPBPR,
    { red, green, blue },
    ["Y", "Pb", "Pr"]
  );
};
...
const getDivider = ({ red, blue }, Yc, chroma) => {
  if (chroma === "Crc") {
    if (conditionals_1.Nr <= red - Yc || red - Yc <= 0) return 1.7182;
    else return 0.9938;
  }
  if (conditionals_1.Nb <= blue - Yc || blue - Yc <= 0) return 1.9404;
  else return 1.582;
};
/**
...
const sRgbToYCgCo = ({ red, green, blue }) => {
  return (0, matrix_1.matrixByVectorObjMultiAsSpace)(
    cb_cr_conversions_matrices_1.CB_CR_CONVERSION_MATRICES.RGB_TO_YCOCG,
    { red, green, blue },
    ["Y", "Co", "Cg"]
  );
};
...
const sRgbToYiq = ({ red, green, blue }) => {
  if (red !== green || green !== blue) {
    return (0, matrix_1.matrixByVectorObjMultiAsSpace)(
      cb_cr_conversions_matrices_1.CB_CR_CONVERSION_MATRICES.RGB_TO_YIQ,
      { red, green, blue },
      ["Y", "I", "Q"]
    );
...
const sRgbToXvYcc = (rgb) => {
  return (0, ycbcr_jpeg_conversions_1.yCbCrBT601ToXvYcc)(
    (0, exports.sRgbToYCbCrBT601)(rgb)
  );
};
