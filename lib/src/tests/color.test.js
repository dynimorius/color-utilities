...
const checkIfInExceptibleRange = (color, testColor) => {
    expect(color.rgb.red).toBeGreaterThanOrEqual(testColor.rgb.red - 1);
    expect(color.rgb.red).toBeLessThan(testColor.rgb.red + 1);
    expect(color.rgb.green).toBeGreaterThanOrEqual(testColor.rgb.green - 1);
    expect(color.rgb.green).toBeLessThan(testColor.rgb.green + 1);
    expect(color.rgb.blue).toBeGreaterThanOrEqual(testColor.rgb.blue - 1);
    expect(color.rgb.blue).toBeLessThan(testColor.rgb.blue + 1);
};
const testConversions = (rgb) => {
    const testColor = new color_1.Color("rgb", rgb);
