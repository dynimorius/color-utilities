  ...
  constructor(color1, color2, oprions) {
    ...
    this.color =
      oprions.returnType === "rgb" || !oprions.returnType
        ...
        : ((_a = convertor_map_1.colorConverters[oprions.returnType]) ===
            null || _a === void 0
            ? void 0
            : _a.fun)((0, exports.blend)(this.rgb1, this.rgb2, weight));
    this.blendData = {
      color1: {
        data: color1,
...
const getColorType = (color) => {
  if (typeof color.green === "number" || typeof color.g === "number")
    return "rgb";
  if (typeof color.cyan === "number" || typeof color.c === "number")
    return "cmyk";
  if (typeof color.x == "number") return "xyz";
  if (typeof color.yellow === "number" || typeof color.y === "number")
    return "ryb";
  if (typeof color.lightness === "number" || typeof color.l === "number")
    return "hsl";
  if (typeof color.value === "number" || typeof color.v === "number")
    return "hsv";
  return "hex";
};
