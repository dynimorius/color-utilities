 ...
 */
export const checkAndFormat = (space, color) => {
...
const hexColorCheck = (color) => {
    if (new RegExp(FULL_HEX).exec(color))
        return color.slice(1).toUpperCase();
    else if (new RegExp(HEX).exec(color))
...
const colorCheckerMap = {
    ...
    xyy: xyYColorCheck,
    xyz: xyzColorCheck,
    ycbcr_BT601: yCbCrColorCheck,
    ycbcr_BT709: yCbCrColorCheck,
    ycbcr_BT2020: yCbCrColorCheck,
