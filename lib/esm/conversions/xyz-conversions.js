...
import { LCompanding, companding, gammaCompanding, sRgbCompanding, } from "../helpers/companding";
 ...
 */
export const xyzToLuv = ({ x, y, z }, refIlluminant = REFERENCE_ILLUMINANT.D65) => {
    x = x > 1 ? x / 100 : x;
    y = y > 1 ? y / 100 : y;
    z = z > 1 ? z / 100 : z;
 ...
 */
export const xyzToUvw = ({ x, y, z }, refIlluminant = REFERENCE_ILLUMINANT.D65) => {
    const u0 = Fu({
        x: refIlluminant.X,
        y: refIlluminant.Y,
        z: refIlluminant.Z,
 ...
 */
export const xyzToGammaRgb = (xyz, ref, whitInBounds) => {
 ...
 */
export const xyzToAdobeRgb = (xyz) => {
 ...
 */
export const xyzToAppleRgb = (xyz) => {
 ...
 */
export const xyzToBruceRgb = (xyz) => {
 ...
 */
export const xyzToColorMatchRgb = (xyz) => {
 ...
 */
export const xyzToEtkaSpacePs5 = (xyz) => {
 ...
 */
export const xyzToPalSecamRgb = (xyz) => {
 ...
 */
export const xyzToProPhotoRgb = (xyz) => {
 ...
 */
export const xyzToSmpteCRgb = (xyz) => {
 ...
 */
export const xyzToWideGamutRgb = (xyz) => {
 ...
 */
export const xyzToEciRgbV2 = (xyz) => {
 ...
 */
export const xtzToLms = (xyz, matrix) => {
    if (!matrix)
        matrix = VON_KRIES_COEFFICIENT_MATRICES.MA;
 ...
 */
export const xyzToHunterLab = ({ x, y, z }) => {
