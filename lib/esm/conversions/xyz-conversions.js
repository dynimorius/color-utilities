...
exports.xyzToHunterLab = exports.xyzToLms = exports.xyzToXyY = exports.xyzToLRgb = exports.xyzToEciRgbV2 = exports.xyzToWideGamutRgb = exports.xyzToSmpteCRgb = exports.xyzToProPhotoRgb = exports.xyzToPalSecamRgb = exports.xyzToNtscRgb = exports.xyzToEtkaSpacePs5 = exports.xyzToDonRgb4 = exports.xyzToColorMatchRgb = exports.xyzToCieRgb = exports.xyzToBruceRgb = exports.xyzToBetaRgb = exports.xyzToBestRgb = exports.xyzToAppleRgb = exports.xyzToAdobeRgb = exports.xyzToGammaRgb = exports.xyzToSrgb = exports.xyzToUvw = exports.xyzToLch_uv = exports.xyzToLuv = exports.xyzToLch_ab = exports.xyzToLab = void 0;
 ...
 */
const xyzToLch_ab = (xyz) => {
    return (0, lab_conversions_1.labToLch_ab)((0, exports.xyzToLab)(xyz));
};
exports.xyzToLch_ab = xyzToLch_ab;
/**
 * Gets Luv values from given xyz values
 * @param {XYZ}                     - xyz values for a color
 * @returns {LUV}                   - luv values for a color
 */
const xyzToLuv = ({ x, y, z }, refIlluminant = reference_illuminants_1.REFERENCE_ILLUMINANT.D65) => {
    x = x > 1 ? x / 100 : x;
    y = y > 1 ? y / 100 : y;
    z = z > 1 ? z / 100 : z;
 ...
 * @returns {LCH}                   - LCH values for a color
 */
const xyzToLch_uv = (xyz) => {
    return (0, luv_conversions_1.luvToLch_uv)((0, exports.xyzToLuv)(xyz));
};
exports.xyzToLch_uv = xyzToLch_uv;
/**
 * Gets UVW values from given xyz values
 * @param {XYZ}                     - xyz values for a color
 * @returns {UVW}                   - uvw values for a color
 */
const xyzToUvw = ({ x, y, z }, refIlluminant = reference_illuminants_1.REFERENCE_ILLUMINANT.D65) => {
    const u0 = (0, white_point_1.Fu)({
        x: refIlluminant.X,
        y: refIlluminant.Y,
        z: refIlluminant.Z,
 ...
 */
const xyzToSrgb = (xyz) => {
    return xyzToRgb(xyz, space_datasets_1.SPACE_DATASETS.SRGB, companding_1.sRgbCompanding);
};
...
const xyzToGammaRgb = (xyz, ref, whitInBounds) => {
    return xyzToRgb(xyz, ref, companding_1.gammaCompanding, { gamma: true, whitInBounds });
};
 ...
 */
const xyzToLRgb = (xyz) => {
    return xyzToRgb(xyz, space_datasets_1.SPACE_DATASETS.ECI_RGB_V2, companding_1.LCompanding);
};
 ...
 */
const xyzToLms = (xyz, matrix) => {
    if (!matrix)
        matrix = transform_matrixes_1.VON_KRIES_COEFFICIENT_MATRICES.MA;
