...
import { inverseCompanding, inverseGammaCompanding, inverseLCompanding, inverseSrbgCompanding, } from "../helpers/companding";
 ...
 */
export const normalizeRgba = ({ red, green, blue, alpha }) => ({
    red: red / 255,
    green: green / 255,
    blue: blue / 255,
    alpha,
});
export const deNormalizeRGB = ({ red, green, blue }) => ({
    red: red * 255,
    green: green * 255,
    blue: blue * 255,
});
 ...
 */
export const rgbInvert = ({ red, green, blue }) => ({
    red: 255 - red,
    green: 255 - green,
    blue: 255 - blue,
});
 ...
 */
export const sRgbToHue = (red, green, blue, max, delta) => {
    let hue = 0;
    switch (max) {
        case red:
 ...
 */
export const sRgbToLuminance = ({ red, green, blue }) => 0.2126 * red + 0.7152 * green + 0.0722 * blue;
/*******************************************************************
 *                        ADOBE 1998 RGB
 * *****************************************************************/
/**
 ...
 */
export const sRgbToAdobeRgb = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 */
export const adobeRgbToXyz = (rgb) => {
 ...
 */
export const sRgbToAppleRgb = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 * @returns {XYZ}                 - xyz values
 */
export const appleRgbToXyz = (rgb) => {
 ...
 */
export const sRgbToBestRgb = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 */
export const sRgbToBetaRgb = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 */
export const sRgbToBruceRgb = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 * @returns {XYZ}                 - xyz values
 */
export const bruceRgbToXyz = (rgb) => {
 ...
 */
export const sRgbToCieRgb = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 */
export const sRgbToColorMatchRgb = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 * @returns {XYZ}                 - xyz values
 */
export const colorMatchRgbToXyz = (rgb) => {
 ...
 */
export const sRgbToDonRgb4 = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 */
export const sRgbToEtkaSpacePs5 = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 * @returns {XYZ}                - xyz values
 */
export const etkaSpacePs5ToXyz = (rgb) => {
 ...
 */
export const sRgbToNtscRgb = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 */
export const sRgbToPalSecamRgb = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 * @returns {XYZ}                 - xyz values
 */
export const palSecamRgbToXyz = (rgb) => {
 ...
 */
export const sRgbToProPhotoRgb = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 * @returns {XYZ}                 - xyz values
 */
export const proPhotoRgbToXyz = (rgb) => {
 ...
 */
export const sRgbToSmpteCRgb = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 * @returns {XYZ}                 - xyz values
 */
export const smpteCRgbToXyz = (rgb) => {
 ...
 */
export const sRgbToWideGamutRgb = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 * @returns {XYZ}                 - xyz values
 */
export const wideGamutRgbToXyz = (rgb) => {
 ...
 */
export const sRgbToEciRgbV2 = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 * @returns {XYZ}                 - xyz values
 */
export const eciRgbV2ToXyz = (rgb) => {
 ...
 */
export const sRgbToAnsi16 = (rgb, saturation = null) => {
    let value;
    if (saturation)
        value = saturation;
    else {
 ...
 */
export const sRgbToAnsi256 = ({ red, green, blue }) => {
    red = clamp(red, 0, 255);
 ...
 */
export const sRgbToCmyk = (rgb, round) => {
 ...
 */
export const sRgbToHex = ({ red, green, blue }, prefixed) => {
 ...
 * @returns {string}               - hex string
 */
export const sRgbaToHex = ({ red, green, blue, alpha }, prefixed) => {
    const integer = ((Math.round(red) & 0xff) << 16) +
        ((Math.round(green) & 0xff) << 8) +
        (Math.round(blue) & 0xff);
    const string = integer.toString(16).toUpperCase();
 ...
 */
export const sRgbToHsl = (rgb, pHue) => {
    const { red, green, blue } = normalizeRgb(rgb);
    ...
    if (!delta)
        ...
        saturation = formatValue(lightness > 0.5 ? delta / (2 - max - min) : delta / (max + min));
    if (!pHue)
 ...
 */
export const sRgbToHsv = (rgb, pHue) => {
    const { red, green, blue } = normalizeRgb(rgb);
 ...
 */
export const sRgbToHwb = (rgb, pHue) => {
    const { red, green, blue } = normalizeRgb(rgb);
    let hue;
    if (!pHue) {
        const { max, delta } = getRange(red, green, blue);
 ...
 */
export const sRgbToLab = (rgb, xyz = sRgbToXyz(rgb)) => {
    return xyzToLab(xyz);
};
/*******************************************************************
 *                             LCH
 ...
 */
export const sRgbToLch_ab = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 */
export const sRgbToLch_uv = (rgb, xyz = sRgbToXyz(rgb)) => {
 ...
 */
export const sRgbToLuv = (rgb, xyz = sRgbToXyz(rgb)) => {
    return xyzToLuv(xyz);
};
/*******************************************************************
 *                             RYB
 ...
 */
export const sRgbToRyb = ({ red, green, blue }) => {
 ...
 */
export const sRgbToTsl = ({ red, green, blue }) => {
...
const rgbToXyz = (rgb, space, inverseCompandingFun, gamma) => {
    const { Rlin, Glin, Blin } = inverseCompanding(rgb, space, inverseCompandingFun, gamma);
 ...
 * @returns {XYZ}                 - xyz values
 */
export const gammaRgbToXyz = (rgb, ref) => {
 ...
 */
export const sRgbToYCbCrBT601 = ({ red, green, blue }) => {
    const { Y, Cb, Cr } = matrixByVectorObjMultiAsSpace(CB_CR_CONVERSION_MATRICES.RGB_TO_YCBCR_BT_601, { red, green, blue }, ["Y", "Cb", "Cr"]);
    return {
        Y: 16 + Y,
        Cb: 128 + Cb,
        Cr: 128 + Cr,
 ...
 * @returns {YCbCr}               - YCbCr values for a color
 */
export const sRgbToYCbCrBT709 = ({ red, green, blue }) => {
    return matrixByVectorObjMultiAsSpace(CB_CR_CONVERSION_MATRICES.RGB_TO_BT_709_YCBCR, { red, green, blue }, ["Y", "Cb", "Cr"]);
};
/**
 ...
 */
export const sRgbToYDbDr = ({ red, green, blue }) => {
    return matrixByVectorObjMultiAsSpace(CB_CR_CONVERSION_MATRICES.RGB_TO_YDBDR, { red, green, blue }, ["Y", "Db", "Dr"]);
};
/**
 ...
 */
export const sRgbToYPbPr = ({ red, green, blue }) => {
    return matrixByVectorObjMultiAsSpace(CB_CR_CONVERSION_MATRICES.RGB_TO_YPBPR, { red, green, blue }, ["Y", "Pb", "Pr"]);
};
/**
 ...
 */
export const sRgbToYcCbcCrc = ({ red, green, blue }) => {
...
const getDivider = ({ red, blue }, Yc, chroma) => {
    if (chroma === "Crc") {
        if (Nr <= red - Yc || red - Yc <= 0)
            return 1.7182;
        else
            return 0.9938;
    }
    if (Nb <= blue - Yc || blue - Yc <= 0)
        return 1.9404;
    else
        return 1.582;
};
 ...
 */
export const sRgbToYCgCo = ({ red, green, blue }) => {
    return matrixByVectorObjMultiAsSpace(CB_CR_CONVERSION_MATRICES.RGB_TO_YCOCG, { red, green, blue }, ["Y", "Co", "Cg"]);
};
/**
 ...
 */
export const sRgbToYiq = ({ red, green, blue }) => {
    if (red !== green || green !== blue) {
        return matrixByVectorObjMultiAsSpace(CB_CR_CONVERSION_MATRICES.RGB_TO_YIQ, { red, green, blue }, ["Y", "I", "Q"]);
    }
    else
