...
import { adobeRgbToXyz, appleRgbToXyz, bestRgbToXyz, betaRgbToXyz, bruceRgbToXyz, cieRgbToXyz, colorMatchRgbToXyz, donRgb4ToXyz, eciRgbV2ToXyz, etkaSpacePs5ToXyz, ntscRgbToXyz, palSecamRgbToXyz, proPhotoRgbToXyz, rgbTo1_0rgb, sRgbToAdobeRgb, sRgbToAnsi16, sRgbToAnsi256, sRgbToAppleRgb, sRgbToBestRgb, sRgbToBetaRgb, sRgbToBruceRgb, sRgbToCieRgb, sRgbToCmy, sRgbToCmyk, sRgbToColorMatchRgb, sRgbToDonRgb4, sRgbToEciRgbV2, sRgbToEtkaSpacePs5, sRgbToHcy, sRgbToHex, sRgbToHsi, sRgbToHsl, sRgbToHsv, sRgbToHwb, sRgbToLab, sRgbToLch_ab, sRgbToLch_uv, sRgbToLuv, sRgbToNtscRgb, sRgbToPalSecamRgb, sRgbToProPhotoRgb, sRgbToRyb, sRgbToSmpteCRgb, sRgbToTsl, sRgbToUvw, sRgbToWideGamutRgb, sRgbToXvYcc, sRgbToXyz, sRgbToYCbCrBT601, sRgbToYCbCrBT709, sRgbToYCgCo, sRgbToYDbDr, sRgbToYPbPr, sRgbToYcCbcCrc, sRgbToYiq, smpteCRgbToXyz, wideGamutRgbToXyz, } from "./conversions/rgb-conversions";
...
import { xtzToLms, xyzToAdobeRgb, xyzToAppleRgb, xyzToBestRgb, xyzToBetaRgb, xyzToBruceRgb, xyzToCieRgb, xyzToColorMatchRgb, xyzToDonRgb4, xyzToEciRgbV2, xyzToEtkaSpacePs5, xyzToHunterLab, xyzToLab, xyzToLch_ab, xyzToLch_uv, xyzToLuv, xyzToNtscRgb, xyzToPalSecamRgb, xyzToProPhotoRgb, xyzToSmpteCRgb, xyzToSrgb, xyzToUvw, xyzToWideGamutRgb, xyzToXyY, } from "./conversions/xyz-conversions";
 ...
 */
export const fromRgbConverters = {
...
export const fromXyzConverters = {
    lab: xyzToLab,
    lch_ab: xyzToLch_ab,
    lch_uv: xyzToLch_uv,
    luv: xyzToLuv,
