...
const color2 = new ColorResolver('rgb',{  red: 91, green: 59, blue: 107 });
...
// const color9 = new ColorResolver('adobe_98_rgb',{r: 62.969, g: 133.969, b: 162.974}); 
// console.log(color9.data());
