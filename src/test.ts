  ...
  colors.forEach((color) => {
    if (!checkRgb(color.rgb)) {
      ...
      console.log(
        ...
        `\n----------------------------------------------\n`,
        `Diff\n`,
        `{ red: ${color.rgb.red - testColor.red}, green: ${
          color.rgb.green - testColor.green
        }, blue: ${color.rgb.blue - testColor.blue}} \n`,
        `{ x: ${color.xyz.x - (checkColor.data().xyz as XYZ).x}, y: ${
          color.xyz.y - (checkColor.data().xyz as XYZ).y
        }, z: ${color.xyz.z - (checkColor.data().xyz as XYZ).z}} \n ${
          checkColor.data().hex
        } - ${color.hex} 
        `,
        `\n----------------------------------------------\n`
