 ...
 */
export const matrix3x3Multi = (a, b) => {
    return [
        [
 ...
 */
export const matrixVectorMulti = (matrix, vector) => {
    return [
        matrix[0][0] * vector[0] +
            matrix[0][1] * vector[1] +
            matrix[0][2] * vector[2],
 ...
 */
export const matrixByVectorObjMulti = (matrix, vector) => {
 ...
 * @returns {{ [key: string]: number }} - resulting vector object
 */
export const matrixByVectorObjMultiAsSpace = (matrix, vector, space) => {
    const entries = Object.entries(vector);
    return {
 ...
 */
export const matrixVectorMultiAsXyz = (matrix, vector) => {
    return {
 ...
 * @returns {XYZ}                       - resulting xyz object
 */
export const matrixSpaceMultiAsXyz = (matrix, vector) => {
 ...
 */
export const matrixXyzMultiAsSpace = (matrix, vector, space) => {
    return {
 ...
 * @returns {{ [key: string]: number }} - resulting color space object
 */
export const matrixRgbMultiAsSpace = (matrix, vector, space) => {
