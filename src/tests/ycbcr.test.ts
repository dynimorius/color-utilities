...
const TestBT601 = (rgb: { red: number; green: number; blue: number }) => {
  test(`Checking RGB <-> YCbCr BT601 conversions of R: ${rgb.red} G: ${rgb.green} B: ${rgb.blue}`, () => {
    expect(
...
TestBT601({ red: 50, green: 49, blue: 50 }); // Black


const TestBT709 = (rgb: { red: number; green: number; blue: number }) => {
  test(`Checking RGB <-> YCbCr BT709 conversions of R: ${rgb.red} G: ${rgb.green} B: ${rgb.blue}`, () => {
    expect(
...
//TODO
// const TestBT2020 = (rgb: { red: number; green: number; blue: number }) => {
//   test(`Checking RGB <-> YCbCr BT2020 conversions of R: ${rgb.red} G: ${rgb.green} B: ${rgb.blue}`, () => {
//     expect(
...
// TestBT2020({ red: 50, green: 49, blue: 50 });